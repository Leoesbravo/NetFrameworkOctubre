...
namespace DL_EF
{
    ...
    public partial class IEspinozaProgramacionNCapasGenOctubreEntities1 : DbContext
    {
        public IEspinozaProgramacionNCapasGenOctubreEntities1()
            : base("name=IEspinozaProgramacionNCapasGenOctubreEntities1")
        {
        }
        ...
        public virtual ObjectResult<HorarioGetByIdGrupo_Result> HorarioGetByIdGrupo(Nullable<int> idGrupo)
        {
            var idGrupoParameter = idGrupo.HasValue ?
                new ObjectParameter("IdGrupo", idGrupo) :
                new ObjectParameter("IdGrupo", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<HorarioGetByIdGrupo_Result>("HorarioGetByIdGrupo", idGrupoParameter);
        }
